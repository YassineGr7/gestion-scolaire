        ...
        <div class="m-5">
            <button
                ...
                <span
                    ...
                    <a href="{{ route('add-student') }}">Add New Student <i class="fa-solid fa-user-plus mx-2"
                ...
                @forelse ($students as $student)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="px-6 py-4 font-medium text-blue-500 whitespace-nowrap dark:text-blue-500">
                            <a href="{{route('show-student', ['id' => $student->id])}}">{{ $student->nom }}</a>
                        </th>
                        ...
                        <td class="px-6 py-4 ">
                          <form action="{{route('destroy-student',['id'=>$student->id])}}" method="post">
                          @csrf
                          @method('DELETE')
                          <a href="{{route('edit-student', ['id'=>$student->id])}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
