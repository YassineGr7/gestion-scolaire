        ...
        <div class="m-5">
            <button
                ...
                <span
                    ...
                    <a href="{{ route('add-teacher') }}">Add New Teacher <i class="fa-solid fa-user-plus mx-2"
                ...
                @forelse ($teachers as $teacher)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="px-6 py-4 font-medium text-blue-500 whitespace-nowrap dark:text-blue-500">
                            <a href="{{route('show-teacher',['id'=>$teacher->id])}}">
                              {{ $teacher->nom }}
                            </a>
                        </th>
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <form action="{{ route('destroy-teacher', ['id' => $teacher->id]) }}" method="post">
                                @csrf
                                @method('DELETE')
